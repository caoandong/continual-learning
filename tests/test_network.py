...
from continual_learning.types import NetworkStepInput
...
def test_step_network_returns_prediction() -> None:
    ...
    result = step_network(state, step_input, call_llm_mock)
...
def test_step_network_survives_neuron_removal() -> None:
    ...
    from continual_learning.types import LayerState, NetworkState
